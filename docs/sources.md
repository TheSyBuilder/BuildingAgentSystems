...
| Agent architecture | Workflows follow predefined code paths; agents let models dynamically direct processes and tool use, and should use environmental feedback and stopping conditions. | https://www.anthropic.com/engineering/building-effective-agents | verified: 2026-08-04 |
| Agent boundary | An LLM application is not an agent unless the model controls workflow execution; agents combine models, tools, and instructions inside guardrails with explicit exit and handoff conditions. | https://cdn.openai.com/business-guides-and-resources/a-practical-guide-to-building-agents.pdf | verified: 2026-08-04 |
| Agent context | Context is the finite set of tokens supplied for the current inference, including instructions, tool definitions, external data, results, and selected history; it must be curated as a run evolves. | https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents | verified: 2026-08-04 |
| Agent session state | A TypeScript agent session can retrieve prior conversation items, merge them into a later turn, persist new items, and resume an interrupted run; storage lifetime remains an application choice. | https://openai.github.io/openai-agents-js/guides/sessions/ | verified: 2026-08-04 |
